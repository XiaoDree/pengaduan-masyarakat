        ...
        <div>
          <?php foreach ($data_kategori as $dk) : ?>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="kategori" id="<?= $dk->id ?>" value="<?= $dk->jenis_pengaduan ?>">
              <label class="form-check-label" for="insfrastruktur"><?= $dk->jenis_pengaduan ?></label>
            </div>
          <?php endforeach; ?>
        </div>
      </div>
