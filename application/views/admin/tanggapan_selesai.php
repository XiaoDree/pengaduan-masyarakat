		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<select class="form-control" id="kategori" name="kategori" onchange="location = this.value;">
					<option value="/pengaduan-masyarakat/Admin/TanggapanController/tanggapan_selesai?jp=semua">Semua</option>
					<?php foreach ($kategori as $kategori) : ?>
						<option value="<?php echo '/pengaduan-masyarakat/Admin/TanggapanController/tanggapan_selesai?jp=' . $kategori->jenis_pengaduan; ?>" <?php echo $data_filter == $kategori->jenis_pengaduan ? 'selected' : '' ?>><?php echo $kategori->jenis_pengaduan; ?></option>
					<?php endforeach; ?>
				</select>
			</div>
		</div>
